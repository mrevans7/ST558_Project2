...
In this report, we will be analyzing an online news data set for Friday.
...
| ---------------------- | --: | ------------: | --------: | ---: | -----: | ---: | ----: |
| More Than 1,400 Shares | 304 |           424 |        99 |  243 |     69 |  241 |   577 |
| Less Than 1,400 Shares | 281 |           257 |       114 |  424 |    172 |  454 |   331 |
...
|  | 1st Qu.: 9.00    | 1st Qu.: 240.0     | 1st Qu.: 4.00  | 1st Qu.: 1.000   | 1st Qu.: 1.000 | 1st Qu.: 0.000 |
|  | Median :10.00    | Median : 408.0     | Median : 8.00  | Median : 2.000   | Median : 1.000 | Median : 0.000 |
|  | Mean :10.37      | Mean : 535.4       |  Mean : 10.93  | Mean : 3.053     |  Mean : 4.398  |  Mean : 1.268  |
|  | 3rd Qu.:12.00    | 3rd Qu.: 699.8     | 3rd Qu.: 14.00 | 3rd Qu.: 4.000   | 3rd Qu.: 3.000 | 3rd Qu.: 1.000 |
|  | Max. :23.00      | Max. :7413.0       |  Max. :171.00  | Max. :116.000    | Max. :108.000  |  Max. :51.000  |
...
![](Friday-Report_files/figure-gfm/plot1-1.png)<!-- -->
...
![](Friday-Report_files/figure-gfm/plot2-1.png)<!-- -->
...
![](Friday-Report_files/figure-gfm/plot3-1.png)<!-- -->
...
![](Friday-Report_files/figure-gfm/plot4-1.png)<!-- -->
...
```
    ...
    ##           -3.126e-01             1.100e-02             5.287e-05             1.173e-02            -1.284e-02  
    ##             num_imgs            num_videos  channelEntertainment      channelLifestyle           channelNone  
    ##            1.193e-02             1.089e-02            -5.174e-01             1.351e-01             4.890e-01  
    ##        channelSocMed           channelTech          channelWorld  
    ##            9.588e-01             6.985e-01            -5.300e-01  
    ## 
    ## Degrees of Freedom: 3989 Total (i.e. Null);  3977 Residual
    ## Null Deviance:       5530 
    ## Residual Deviance: 5228  AIC: 5254
...
```
    ...
    ## Summary of sample sizes: 3591, 3591, 3592, 3591, 3590, 3592, ... 
    ## Resampling results:
    ## 
    ##   Accuracy   Kappa    
    ##   0.5882202  0.1760771
...
The logistic regression model has an accuracy of 0.5885447.
...
```
    ...
    ##                  95% CI : (0.5677, 0.6149)
    ##     No Information Rate : 0.5137          
    ##     P-Value [Acc > NIR] : 6.357e-11       
    ##                                           
    ##                   Kappa : 0.1835          
    ##                                           
    ##  Mcnemar's Test P-Value : 0.09607         
    ##                                           
    ##             Sensitivity : 0.5768          
    ##             Specificity : 0.6070          
...
The logistic regression model has an accuracy of 0.591467.
...
With an accuracy of 0.591467, we conclude that the Bagged Trees Model is
better at predicting whether or not a Mashable article will get more or
less than 1,400 shares.
